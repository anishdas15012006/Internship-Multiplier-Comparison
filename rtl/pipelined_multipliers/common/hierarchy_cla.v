// // This is the Hierarchial CLA
// // Taken from Original Implementations in Multiplier_Architectures Folder
// // Uncomment to use it and also change the name in the Project Tree Section in the Left
...
// // -----------------------------------------------------------------------------
// module carry_lookahead_adder #(
//     parameter integer N = 128   // Must be 4, 8, 16, 32, or 64
// )(
//     input  wire [N-1:0] A,
//     input  wire [N-1:0] B,
//     input  wire         Cin,
