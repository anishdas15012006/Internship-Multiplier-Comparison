...
module tb_baugh_wooley_dadda_16;
...
baugh_wooley_dadda_16 DUT_SS (.A(A), .B(B), .P(P_ss));

initial begin

    $dumpfile(
        "waves/baugh_wooley/baugh_wooley_dadda/baugh_wooley_dadda_16.vcd"
    );

    $dumpvars(
        0,
        tb_baugh_wooley_dadda_16
    );
