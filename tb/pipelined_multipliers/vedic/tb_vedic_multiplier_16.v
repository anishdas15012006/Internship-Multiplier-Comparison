...
initial begin
    $dumpfile("waves/vedic/vedic_16.vcd");
    $dumpvars(0, tb_vedic_multiplier_16);
    ...
    for(i = 0; i < 10000; i = i + 1) begin
        ...
        if (pipe_count >= 3) begin
            if (P !== ({ 16'b0, history_A_3 } * { 16'b0, history_B_3 })) begin
                $display("FAIL A=%0d B=%0d EXP=%0d GOT=%0d", $unsigned(history_A_3), $unsigned(history_B_3), $unsigned({ 16'b0, history_A_3 } * { 16'b0, history_B_3 }), $unsigned(P));
