...
initial begin
    $dumpfile("waves/wallace/wallace_16.vcd");
    $dumpvars(0, tb_wallace_multiplier_16);
    ...
    for(i = 0; i < 10000; i = i + 1) begin
        ...
        if (pipe_count >= 5) begin
            if (P !== ({ 16'b0, history_A_5 } * { 16'b0, history_B_5 })) begin
                $display("FAIL A=%0d B=%0d EXP=%0d GOT=%0d", $unsigned(history_A_5), $unsigned(history_B_5), $unsigned({ 16'b0, history_A_5 } * { 16'b0, history_B_5 }), $unsigned(P));
