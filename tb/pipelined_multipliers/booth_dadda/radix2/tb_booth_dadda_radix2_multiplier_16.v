...
module tb_booth_dadda_radix2_multiplier_16 #(
...
booth_dadda_radix2_multiplier_16 #(
    .SIGNED_A(SIGNED_A),
    .SIGNED_B(SIGNED_B)
) DUT (
...
always #10 clk = ~clk;
    ...
    wire [31:0] expected_P = (SIGNED_A && SIGNED_B) ? ref_ss :
                                        ...
                                        (SIGNED_B)            ? ref_us :
                                                                ref_uu;
initial begin
    $dumpfile("waves/booth_dadda/radix2/booth_dadda_radix2_16.vcd");
    $dumpvars(0, tb_booth_dadda_radix2_multiplier_16);
